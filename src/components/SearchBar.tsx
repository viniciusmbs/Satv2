...
const SearchBar: React.FC<SearchBarProps> = ({
  ...
  return (
    <div className="bg-[#131b2e] border-b border-slate-800/80 py-3 shadow-inner">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-2.5">
        ...
        <div className="flex flex-col sm:flex-row gap-3 items-center justify-between">
          <div className="relative w-full max-w-xl">
            ...
            <input
              ...
              className="w-full bg-[#1e293b] text-gray-100 placeholder-slate-400 text-sm rounded-xl pl-10 pr-10 py-2 border border-slate-700/80 focus:outline-none focus:ring-2 focus:ring-red-500/80 focus:border-red-500 transition shadow-sm"
            />
            {searchQuery && (
              <button
        ...
        <div className="flex items-center gap-1.5 overflow-x-auto pb-1 no-scrollbar">
          ...
          <button
            ...
            className={`tv-nav-focus px-3 py-1 rounded-lg text-xs font-semibold whitespace-nowrap transition-all outline-none cursor-pointer ${
